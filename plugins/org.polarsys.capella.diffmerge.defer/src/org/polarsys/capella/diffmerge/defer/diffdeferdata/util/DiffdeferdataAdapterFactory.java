 ...
 * @generated
 */
public class DiffdeferdataAdapterFactory extends AdapterFactoryImpl {
  /**
   ...
   * @generated
   */
  protected static DiffdeferdataPackage modelPackage;
   ...
   * @generated
   */
  public DiffdeferdataAdapterFactory() {
    if (modelPackage == null) {
      modelPackage = DiffdeferdataPackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected DiffdeferdataSwitch<Adapter> modelSwitch = new DiffdeferdataSwitch<Adapter>() {
    @Override
    public Adapter caseDeferredComparison(DeferredComparison object) {
      return createDeferredComparisonAdapter();
    }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.polarsys.capella.diffmerge.defer.diffdeferdata.DeferredComparison <em>Deferred Comparison</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createDeferredComparisonAdapter() {
    return null;
  }
