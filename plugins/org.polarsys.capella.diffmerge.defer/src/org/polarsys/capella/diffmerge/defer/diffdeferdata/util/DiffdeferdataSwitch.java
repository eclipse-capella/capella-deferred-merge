 ...
 * @generated
 */
public class DiffdeferdataSwitch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    ...
    case DiffdeferdataPackage.DEFERRED_COMPARISON: {
      DeferredComparison deferredComparison = (DeferredComparison) theEObject;
      T result = caseDeferredComparison(deferredComparison);
      if (result == null)
        result = caseGIdentified(deferredComparison);
      if (result == null)
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Deferred Comparison</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Deferred Comparison</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDeferredComparison(DeferredComparison object) {
    return null;
  }
